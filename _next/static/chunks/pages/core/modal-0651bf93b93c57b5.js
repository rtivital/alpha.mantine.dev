...
`,x={type:"code",code:f,centered:!0,component:function(){let[e,{open:n,close:o}]=(0,c.q)(!1);return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:o,withCloseButton:!1},"Modal without header, press escape or click on overlay to close"),i.createElement(u.z,{onClick:n},"Open Modal"))}};var j=o(22971);let M=["xs","sm","md","lg","xl","55rem","70%","100%"],g={type:"code",component:function(){let[e,n]=(0,i.useState)(!1),[o,t]=(0,i.useState)("md"),l=M.map(e=>i.createElement(u.z,{key:e,variant:"outline",onClick:()=>{t(e),n(!0)}},e));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:()=>n(!1),title:"Introduce yourself!",size:o},i.createElement(m._,{noPadding:!0,noShadow:!0})),i.createElement(j.Z,{justify:"center"},l))}};var y=o(72048),C=o(73988),Text=o(26569);let v=`
...
`,b={type:"code",component:function(){let[e,{close:n,open:o}]=(0,c.q)(!1),[t,{increment:l,decrement:r}]=(0,y.C)(3,{min:0}),a=Array(t).fill(0).map((e,n)=>i.createElement(C.C,{key:n},"Badge ",n));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:n,size:"auto",title:"Modal size auto"},i.createElement(Text.x,null,"Modal with size auto will fits its content"),i.createElement(j.Z,{wrap:"nowrap",mt:"md"},a),i.createElement(j.Z,{mt:"xl"},i.createElement(u.z,{variant:"outline",onClick:l},"Add badge"),i.createElement(u.z,{variant:"outline",onClick:r},"Remove badge"))),i.createElement(u.z,{onClick:o},"Open modal"))},centered:!0,code:v},w=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
